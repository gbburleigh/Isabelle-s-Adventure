...
ml  /c  /coff  /Cp bitmaplib.asm || goto :error
...
link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj libgame.obj bitmaplib.obj
